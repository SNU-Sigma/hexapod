...
if("FALSE" STREQUAL "TRUE")
  set(sound_play_SOURCE_PREFIX /home/donghoonpark/hexapod_ws/src/audio_common/sound_play)
  set(sound_play_DEVEL_PREFIX /home/donghoonpark/hexapod_ws/devel)
  ...
  set(sound_play_INSTALL_PREFIX /home/donghoonpark/hexapod_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sound_play' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/hexapod_ws/install/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
