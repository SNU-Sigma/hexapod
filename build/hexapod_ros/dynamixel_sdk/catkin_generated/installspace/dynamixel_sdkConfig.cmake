...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/hexapod_ws/install/${idir}'.  Ask the maintainer 'Kevin Ochs <kevin.ochs@gmail.com>' to fix it.")
    endif()
